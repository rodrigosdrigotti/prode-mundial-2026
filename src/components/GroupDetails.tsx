...
export default function GroupDetails({
  ...
  const handleSaveLocalMatches = async () => {
    ...
    activeMatches.forEach((m) => {
      ...
      batchUpdates[m.id] = {
        team1Goals: draft.team1Goals,
        team2Goals: draft.team2Goals,
        team1Penalties: draft.team1Penalties !== undefined ? draft.team1Penalties : null,
        team2Penalties: draft.team2Penalties !== undefined ? draft.team2Penalties : null
      };
    });
      ...
      if (onSaveGroupPredictions) {
        ...
        activeMatches.forEach((m) => {
          ...
          onUpdatePrediction(
            ...
            draft.team1Goals,
            draft.team2Goals,
            draft.team1Penalties !== undefined ? draft.team1Penalties : null,
            draft.team2Penalties !== undefined ? draft.team2Penalties : null
          );
        });
      }
      setHasUnsavedChanges(false);
            ...
            <div className="xl:col-span-2 space-y-4">
              ...
              {activeTab.type === 'knockout' ? (
                <BracketVisualizer
                  ...
                  onUpdatePrediction={(matchId, t1Goals, t2Goals, t1Penalties, t2Penalties) => {
                    setDraftMatches((prev) => ({
                      ...prev,
                      [matchId]: {
                        ...prev[matchId],
                        team1Goals: t1Goals,
                        team2Goals: t2Goals,
                        team1Penalties: t1Penalties !== undefined ? t1Penalties : (prev[matchId]?.team1Penalties ?? null),
                        team2Penalties: t2Penalties !== undefined ? t2Penalties : (prev[matchId]?.team2Penalties ?? null)
                      }
                    }));
                    setHasUnsavedChanges(true);
                  }}
